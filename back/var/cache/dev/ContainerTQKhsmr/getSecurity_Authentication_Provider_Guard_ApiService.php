...
}, 1), ($this->privates['security.user.provider.concrete.user_db_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_UserDbProviderService.php')), 'api', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
