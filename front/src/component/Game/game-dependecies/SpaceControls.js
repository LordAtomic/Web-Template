...
export function SpaceControls( character, vectors ) {
...
export function pointerLockConfiguration(){
	console.log("test");
  let documentPointerLockElement = document.pointerLockElement    ||
  ...
  function lockChangeAlert() {
    if (documentPointerLockElement === document.getElementById("game_canvas") ||
